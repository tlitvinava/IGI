...
SECRET_KEY = 'django-insecure-o^fslj+&gzg)hw0$j4ox5#^bzsgas0zajy(=oyck@$bl)4ve+2'
...
TEMPLATES = [
    {
        ...
        # 'DIRS': [],
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # если у вас отдельная директория для шаблонов
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
